...
asm_function ime_compute_sad_16x16_fast_av8
    push_v_regs
    sxtw      x2, w2
    sxtw      x3, w3
    lsl       x2, x2, #1
...
//*/
//
asm_function ime_compute_sad_16x8_av8
...
asm_function ime_compute_sad_16x16_ea8_av8
...
asm_function ime_calculate_sad2_prog_av8
...
asm_function ime_calculate_sad3_prog_av8
...
asm_function ime_sub_pel_compute_sad_16x16_av8
    push_v_regs
    sxtw      x4, w4
    sxtw      x5, w5
    sub       x7, x1, #1                //x left
...
//******************************************************************************
//*/
asm_function ime_compute_sad_16x16_av8
    push_v_regs
    sxtw      x2, w2
    sxtw      x3, w3
    mov       x6, #4
...
asm_function ime_calculate_sad4_prog_av8
    push_v_regs
    sxtw      x2, w2
    sxtw      x3, w3
    sub       x5, x0, #1                //left
...
//*
//*****************************************************************************
asm_function ime_compute_satqd_16x16_lumainter_av8
