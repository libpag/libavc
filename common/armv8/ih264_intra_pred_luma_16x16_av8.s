...
asm_function ih264_intra_pred_luma_16x16_mode_vert_av8
...
asm_function ih264_intra_pred_luma_16x16_mode_horz_av8
...
asm_function ih264_intra_pred_luma_16x16_mode_dc_av8
...
.balign 4
gai1_intrapred_luma_plane_coeffs:
...
asm_function ih264_intra_pred_luma_16x16_mode_plane_av8
    ...
    mov       x4, #-1
    ld1       {v2.2s}, [x1], x8
    adr       x7, gai1_intrapred_luma_plane_coeffs
    ld1       {v0.2s}, [x1]
    rev64     v2.8b, v2.8b
    ld1       {v6.2s, v7.2s}, [x7]
