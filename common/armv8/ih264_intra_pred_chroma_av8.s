...
asm_function ih264_intra_pred_chroma_8x8_mode_dc_av8
...
asm_function ih264_intra_pred_chroma_8x8_mode_horz_av8
...
asm_function ih264_intra_pred_chroma_8x8_mode_vert_av8
...
asm_function ih264_intra_pred_chroma_8x8_mode_plane_av8
    ...
    ld1       {v3.2s}, [x10]
    sub       x5, x3, #8
    adr       x12, gai1_intrapred_chroma_plane_coeffs1
    ...
    mov       v0.16b, v1.16b
    adr       x12, gai1_intrapred_chroma_plane_coeffs2
    ld1       {v8.2s, v9.2s}, [x12]
    mov       v8.d[1], v9.d[0]
    mov       v10.16b, v8.16b
    mov       v22.16b, v8.16b
